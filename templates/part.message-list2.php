...
<div class="talk-body" id="talk-body">
	...
	<div class="talk-author">started from <?=$startedfrom;?> on <?=date("d.m.Y H:i", strtotime($firsttalk['date']));?></div>
	<div class="talk-preview"><?=\OCA\Owncollab_Talks\Helper::firstWords($firsttalk['text'], 10);?></div>
