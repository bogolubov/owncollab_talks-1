...
/*'user_to''user_from''talkmessage''attachfiles''subscribers''sitehost''siteurl''logoimg'*/

$sitehost = $_['sitehost'];
$siteurl = trim($_['siteurl'], '/');
$logoimgfullurl = $siteurl.$_['logoimg'];
$userdisplayname = $_['user_to']['displayname'];
$authordisplayname = $_['user_from']['displayname'];
$talkmessage = $_['talkmessage'];
$attachfiles = $_['attachfiles'];

$listreceievedfullnames = '';
if (!empty($_['subscribers']) && is_array($_['subscribers'])) {
    $listreceievedfullnames = ' and ';
    for ($isc=0; $isc < count($_['subscribers']); $isc ++)
        $listreceievedfullnames .= "<b>{$_['subscribers'][$isc]['displayname']}</b>" . (count($_['subscribers'])-2 >= $isc ? ', ': '');
}
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p>Please answer directly using your preferred email client or login to your
                                            <a href="<?php p($siteurl)?>/index.php"><?php p($sitehost)?></a> instance.</p>

                                        <?php if(!empty($attachfiles)): ?>
                                        <table id="files" border="0" cellpadding="0" cellspacing="0">
                                            <tbody>
                                            <tr>
                                                <td align="left">
                                                ...
                                                <td id="talk-head" align="left">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="vertical-align: bottom;font-family: sans-serif;font-size: 22px;">
                                                                ownCollab
                                                            </td>
                                                        </tr>
                                                        </tbody>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                This email was created by the <a href="https://www.owncollab.com/">ownCollab</a> system on <a href="<?php p($siteurl)?>/index.php"><?php p($sitehost)?></a>.
                            </td>
                        </tr>
                        <tr>
